...
const ClassForm = props => {
    ...
    return (
        ...
        >
            ...
            <Grid item container justify="center" className={`${classes.headerPadding} ${classes.fullWidthItem}`}>
                <Typography variant="h6">What is your preferred course time slot?</Typography>
            </Grid>
            <Grid item container justify="center" className={classes.fullWidthItem}>
                <TextField
                    required
            ...
            <Grid item container justify="center" className={`${classes.headerPadding} ${classes.fullWidthItem}`}>
                <Typography variant="h6">What is your perferred mode of transportation?</Typography>
            </Grid>
            <Grid item container justify="center" className={classes.fullWidthItem}>
                <TextField
                    required
            ...
            <Grid item container justify="center" className={`${classes.headerPadding} ${classes.fullWidthItem}`}>
                <Typography variant="h6">Please List Your Placement Scores:</Typography>
            </Grid>
            <Grid item container justify="center" className={classes.fullWidthItem}>
                <TextField
                    required
            ...
            <Grid item container justify="center" className={`${classes.headerPadding} ${classes.fullWidthItem}`}>
                <Typography variant="h6">When was your testing date and Best Exam?</Typography>
            </Grid>
            <Grid item container justify="center" className={classes.fullWidthItem}>
                <TextField
                    required
            ...
            <Grid item container justify="center" className={`${classes.headerPadding} ${classes.fullWidthItem}`}>
                <Typography variant="h6">Have you completed the ICCB and Empowment forms/surveys?</Typography>
            </Grid>
            <Grid item container justify="center" className={classes.fullWidthItem}>
                <TextField
                    required
